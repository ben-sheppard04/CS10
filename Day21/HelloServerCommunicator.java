...
/**
 * Handles communication with one client for HelloMultiThreadedServer. This thread runs independantly of all other threads
 * 
...
public class HelloServerCommunicator extends Thread {
	...
	public HelloServerCommunicator(Socket sock, int id) { // (listen.accept(), num++)
		this.sock = sock;
		this.id = id;
	}
