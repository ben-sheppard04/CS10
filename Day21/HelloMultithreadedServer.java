...
public class HelloMultithreadedServer {	
	...
	public void getConnections() throws IOException {
		...
		while (true) { // Keeps looping forever
			...
			HelloServerCommunicator client = new HelloServerCommunicator(listen.accept(), num++); // Blocks and wait until someone connects. When someone connects, get socket and pass it to Communicator
			client.setDaemon(true); // handler thread terminates when main thread does. If false, main can end and threads keep running -- "zombie threads"
