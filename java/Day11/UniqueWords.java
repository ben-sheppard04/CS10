...
public class UniqueWords {
	public static void main(String[] args) {
		...
		String[] allWords = page.split("[ .,?!]+"); // Array of strings that are split on punctuation and white space. "Delimiters"
		...
		System.out.println(uniqueWords); //print the unique words in alphabetical order because toString() uses inorder recursion
	}
}
