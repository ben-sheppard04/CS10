/** 
 * Shows the interleaving of operations in incrementing. Does three steps of total++ explicitly
 * 
...
public class IncrementerInterleaving extends Thread {
	...
	public void run() {
		for (int i = 0; i < times; i++) {
			int temp = total;
			System.out.println(name + " gets " + temp); // Really slow so good chance you get interrupted
			temp = temp + 1;
			total = temp;
