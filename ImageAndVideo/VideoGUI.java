...
public class VideoGUI extends ImageGUI {
	...
	protected BufferedImage image;					// image grabbed from webcam (if any) - Last camera image stored here
	...
	public void handleImage() {
		setImage1(image);
	} //handleImage called by VideoGUI each time new phrame arrive
